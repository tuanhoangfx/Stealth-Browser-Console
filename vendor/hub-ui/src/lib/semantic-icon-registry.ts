...
const REGISTRY: Record<SemanticIconKey, SemanticIconMeta> = {
  ...
  "col.directory.code": { icon: Hash, className: "text-blue-300", tone: "blue" },
  "col.directory.name": { icon: ScrollText, className: "text-indigo-300", tone: "indigo" },
  "col.directory.version": { icon: Rocket, className: "text-violet-300", tone: "violet" },
  "col.directory.type": { icon: Puzzle, className: "text-purple-300", tone: "purple" },
  "col.directory.role": { icon: Shield, className: "text-amber-300", tone: "amber" },
  "col.directory.email": { icon: Mail, className: "text-sky-300", tone: "sky" },
  "col.directory.password": { icon: Lock, className: "text-rose-300", tone: "rose" },
  "col.directory.url": { icon: Link2, className: "text-cyan-300", tone: "cyan" },
  "col.directory.path": { icon: FolderOpen, className: "text-amber-300", tone: "amber" },
  "col.directory.host": { icon: Server, className: "text-sky-300", tone: "sky" },
  "col.directory.region": { icon: MapPin, className: "text-emerald-300", tone: "emerald" },
  "col.directory.scope": { icon: Globe2, className: "text-cyan-300", tone: "cyan" },
  "col.directory.mode": { icon: Terminal, className: "text-violet-300", tone: "violet" },
  "col.directory.layer": { icon: Layers, className: "text-indigo-300", tone: "indigo" },
  "col.directory.links": { icon: Network, className: "text-cyan-300", tone: "cyan" },
  "col.directory.load": { icon: Gauge, className: "text-emerald-300", tone: "emerald" },
  "col.directory.manifest": { icon: Database, className: "text-blue-300", tone: "blue" },
  "col.directory.golden": { icon: Star, className: "text-amber-300", tone: "amber" },
  "col.directory.drift": { icon: Activity, className: "text-rose-300", tone: "rose" },
  "col.directory.clone": { icon: Package, className: "text-indigo-300", tone: "indigo" },
  "col.directory.members": { icon: Users, className: "text-indigo-300", tone: "indigo" },
  "col.directory.tools": { icon: LayoutGrid, className: "text-indigo-300", tone: "indigo" },
  "col.directory.notes": { icon: BookOpen, className: "text-amber-300", tone: "amber" },
  "col.directory.synced": { icon: RefreshCw, className: "text-emerald-300", tone: "emerald" },
  "col.directory.userId": { icon: Fingerprint, className: "text-blue-300", tone: "blue" },
  "col.directory.actions": { icon: Zap, className: "text-violet-300", tone: "violet" },
