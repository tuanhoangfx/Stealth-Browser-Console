...
const REGISTRY: Record<SemanticIconKey, SemanticIconMeta> = {
  ...
  "settings.format": { icon: CircleDollarSign, className: "text-amber-300", tone: "amber" },
  ...
  "filter.serviceCount": { icon: Layers, className: "text-indigo-300", tone: "indigo" },
  "filter.usage": { icon: Clock, className: "text-cyan-300", tone: "cyan" },
  "filter.platform": { icon: Globe2, className: "text-cyan-300", tone: "cyan" },
  "filter.quota": { icon: Gauge, className: "text-amber-300", tone: "amber" },
  "filter.plan": { icon: Package, className: "text-indigo-300", tone: "indigo" },
  "filter.billing": { icon: ScrollText, className: "text-violet-300", tone: "violet" },
  "filter.probe": { icon: Radio, className: "text-emerald-300", tone: "emerald" },
  ...
  "col.directory.updated": { icon: RefreshCw, className: "text-sky-300", tone: "sky" },
  "col.directory.qty": { icon: ShoppingCart, className: "text-emerald-300", tone: "emerald" },
  "col.directory.number": { icon: Hash, className: "text-violet-300", tone: "violet" },
...
const DIRECTORY_COLUMN_TH_ICON: Partial<Record<SemanticIconKey, string>> = {
  ...
  "col.directory.updated": "hub-users-th-icon--created",
  "col.directory.qty": "hub-users-th-icon--qty",
  "col.directory.number": "hub-users-th-icon--number",
